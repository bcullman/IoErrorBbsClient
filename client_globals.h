...
extern Color color256;                            // persisted 256-color table
extern Color colorTruecolor;                      // persisted truecolor table
...
extern bool useBlackThemeBackgrounds256;          // 256-color table background fallback hint
extern bool useBlackThemeBackgroundsTruecolor;    // truecolor table background fallback hint
